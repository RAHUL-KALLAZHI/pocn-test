...
@Component({
  selector: 'app-connection-sharepage',
  templateUrl: './connection-sharepage.page.html',
  styleUrls: ['./connection-sharepage.page.scss'],
})
export class ConnectionSharepagePage implements OnInit {
